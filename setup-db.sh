...
CREATE INDEX IF NOT EXISTS idx_codes_distribution_id ON codes(distribution_id);
...
CREATE INDEX IF NOT EXISTS idx_payment_codes_code_id ON payment_codes(code_id);
EOF

# Execute the SQL file
psql -d music_distribution -f /tmp/init.sql
